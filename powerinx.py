...
def download_tse_sectinx(dataday):
    ...
    url='http://www.twse.com.tw/exchangeReport/MI_INDEX?response=html&date={}&type=IND'.format(Time64ToDate(dataday))
    #https://www.twse.com.tw/exchangeReport/MI_INDEX?response=json&date=20190716&type=IND&_=1563283980411
...
if __name__ == '__main__':
    ...
    if len(sys.argv)>1 and sys.argv[1]=='d' :
        ...
        if len(sys.argv)==2:
            ...
            print ('上市多頭:',get_tse_power_inx(dataday,'up'))
            print ('上櫃多頭:',get_otc_power_inx(dataday,'up'))
            print ('上市空頭:',get_tse_power_inx(dataday,'down'))
            print ('上櫃空頭:',get_otc_power_inx(dataday,'down'))
        else:    
            print (len(sys.argv))
